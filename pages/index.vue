...
<template>
  <div>
    <div class="flex flex-col items-center justify-between md:flex-row md:space-x-12">
      <div class="text-center md:text-left">
        ...
        <div class="md:hidden mt-4">
          <AvatarImg sizes="sm:280px md:560px" class="w-56 mx-auto drop-shadow-[0_12px_16px_hsla(244,100%,13%,.3)]" />
        </div>
      ...
      <div class="hidden md:block">
        <AvatarImg sizes="sm:280px md:560px" class="drop-shadow-[0_24px_32px_hsla(244,100%,13%,.3)]" />
      </div>
    </div>
    ...
    <div class="md:mt-12 grid md:grid-cols-[minmax(0,2fr),minmax(0,1fr)] gap-x-8 gap-y-12 md:gap-y-16 justify-between items-start">
      <AboutIntro />
      <AboutProfiles />
